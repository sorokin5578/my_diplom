...
def make_network():
    dataset = make_set('C:\\Users\\Illia\\PycharmProjects\\my_diplom\\Test_network\\new_dataset.csv')
    ...
    text = ["Director of the company was fired", "Apple to Start Reopening Stores in Japan This Week",
